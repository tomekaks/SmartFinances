...
{
    public class UpdateUsersStatusCommandHandler : IRequestHandler<UpdateUsersStatusCommand, Unit>
    {
        ...
        public async Task<Unit> Handle(UpdateUsersStatusCommand request, CancellationToken cancellationToken)
        {
