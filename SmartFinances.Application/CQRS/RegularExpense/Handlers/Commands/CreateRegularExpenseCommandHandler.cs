...
{
    public class CreateRegularExpenseCommandHandler : IRequestHandler<CreateRegularExpenseCommand, Unit>
    {
        ...
        public async Task<Unit> Handle(CreateRegularExpenseCommand request, CancellationToken cancellationToken)
        {
